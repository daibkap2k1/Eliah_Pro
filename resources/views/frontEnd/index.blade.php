...
<section id="banner" class="owl-carousel owl-theme">
    <div class="buh-item cover" style="background-image: url('{{asset('public/frontEnd/images/banner.jpg')}}')">
    ...
    <div class="wp-ah position-relative">
        <div class="wp-container container">
            <div class="list-serive-home">
                <div>
                    <ul>
                        <li><a href=""><span>01.</span>Body treatment</a></li>
                        <li><a href=""><span>02.</span>Professinal makeup</a></li>
                        <li><a href=""><span>03.</span>Maincure & pedicure</a></li>
                        <li><a href=""><span>04.</span>Hair cut & Coloring</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<div class="beaty-product wp-box">
    ...
    <div class="text-center">
        <a href="" class="more-product">View all products</a>
    </div>
</div>
{{-- End beaty-product  --}}
                    ...
                    <div id="owl-text">
                        <div class="otm owl-carousel owl-theme">
                            <div class="owlt-content">
                                ...
                                <p class="text-otm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum
                                    quae magnam eos
                                    neque
                                    natus odio, cupiditate incidunt odit dignissimos ad quos autem temporibus quidem
                                    quas.
...
<div class="wp-box cover" style="background-image: url('{{asset('public/frontEnd/images/home/banner-footer.jpg')}}')">
